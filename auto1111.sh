...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/448627?type=Model&format=SafeTensor&size=pruned&fp=bf16"
)
...
VAE_MODELS=(
    ...
    "https://civitai.com/api/download/models/730961?type=Model&format=SafeTensor" #coverVaginaand Breasts XL
    "https://civitai.com/api/download/models/1037996?type=Model&format=SafeTensor"
